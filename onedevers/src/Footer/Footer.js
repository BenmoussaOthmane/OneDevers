...
const Footer = () => {
    return (
        <div className="bg-gray-900 to-blue-500 px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xxl md:px-24 lg:px-8">
        ...
        <div className="space-y-2 text-sm">
          ...
          <div className="flex">
            ...
            <a
              ...
              title="Our phone"
              className="transition-colors duration-300 text-white hover:text-deep-purple-400"
            >
              850-123-5021
            </a>
          </div>
